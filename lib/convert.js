    ...
    return [
      ...
      },
      {
        ...
        description: 'Determines how request parameters (query parameters, path parameters, headers, or the request' +
         ' body) should be generated. Setting this to schema will cause the importer to use the parameter\'s' +
         ' [schema](https://github.com/raml-org/raml-spec/blob/master/versions/raml-10/raml-10.md#raml-data-types)' +
         ' as an indicator; `example` will cause the [example]' +
